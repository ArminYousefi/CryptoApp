...
import google.yousefi.cryptoapp.ui.previewdata.MarketUiStatePreviewProvider
import google.yousefi.cryptoapp.ui.screen.market.component.MarketCoinItem
import google.yousefi.cryptoapp.ui.screen.market.component.SearchPrompt
import google.yousefi.cryptoapp.ui.theme.AppTheme
import kotlinx.collections.immutable.ImmutableList
import kotlinx.coroutines.launch

/**
 * صفحه‌ی بازار شامل لیست سکه‌ها و ابزارهای مرتبط با آن‌ها.
 *
 * @param onNavigateDetails تابعی که برای رفتن به صفحه‌ی جزئیات سکه‌ها فراخوانی می‌شود
 * @param onNavigateSettings تابعی که برای رفتن به صفحه‌ی تنظیمات فراخوانی می‌شود
 * @param viewModel ViewModel استفاده شده برای ارتباط با داده‌های بازار
 */
@Composable
fun MarketScreen(
