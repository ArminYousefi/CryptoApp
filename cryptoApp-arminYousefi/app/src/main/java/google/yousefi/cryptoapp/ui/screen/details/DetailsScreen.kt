...
import google.yousefi.cryptoapp.ui.previewdata.DetailsUiStatePreviewProvider
import google.yousefi.cryptoapp.ui.screen.details.component.CoinChartCard
import google.yousefi.cryptoapp.ui.screen.details.component.CoinChartRangeCard
import google.yousefi.cryptoapp.ui.screen.details.component.EmptyTopBar
import google.yousefi.cryptoapp.ui.screen.details.component.MarketStatsCard
import google.yousefi.cryptoapp.ui.theme.AppTheme

/**
 * نمایش جزئیات صفحه، که شامل نوار بالا و محتوای اصلی است.
 *
 * @param viewModel ViewModel استفاده شده برای ارتباط با داده‌های جزئیات
 * @param onNavigateUp کلید برگشت به صفحه قبلی
 */
@Composable
fun DetailsScreen(
