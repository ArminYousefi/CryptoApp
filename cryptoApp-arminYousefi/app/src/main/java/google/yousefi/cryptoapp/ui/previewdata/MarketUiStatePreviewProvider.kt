...
import google.yousefi.cryptoapp.ui.previewdata.CoinListPreviewData.coins
import google.yousefi.cryptoapp.ui.screen.market.MarketUiState
import kotlinx.collections.immutable.persistentListOf

/**
 * ارائه‌دهنده‌ی پیش‌نمایش برای وضعیت‌های مختلف MarketUiState.
 */
class MarketUiStatePreviewProvider : PreviewParameterProvider<MarketUiState> {
    /**
     * توالی مقادیر حاوی وضعیت‌های مختلف MarketUiState برای نمایش.
     */
...
/**
 * شیء حاوی داده‌های پیش‌نمایش برای لیست سکه‌ها در بازار.
 */
private object CoinListPreviewData {
    /**
     * لیست سکه‌های موجود برای موارد پیش‌نمایش.
     */
