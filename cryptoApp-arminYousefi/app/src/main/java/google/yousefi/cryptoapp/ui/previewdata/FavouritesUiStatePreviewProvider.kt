...
import google.yousefi.cryptoapp.ui.previewdata.FavouritesPreviewData.favouriteCoins
import google.yousefi.cryptoapp.ui.screen.favourites.FavouritesUiState
import kotlinx.collections.immutable.persistentListOf
import java.math.BigDecimal

/**
 * PreviewParameterProvider برای نمایش وضعیت‌های مختلف FavouritesUiState.
 */
class FavouritesUiStatePreviewProvider : PreviewParameterProvider<FavouritesUiState> {
    /**
     * توالی مقادیر حاوی وضعیت‌های مختلف FavouritesUiState برای نمایش.
     */
