...
import google.yousefi.cryptoapp.ui.screen.details.DetailsUiState
import kotlinx.collections.immutable.persistentListOf
import java.math.BigDecimal

/**
 * ارائه‌دهنده‌ی پیش‌نمایش برای موارد پارامتری از نوع DetailsUiState.
 */
class DetailsUiStatePreviewProvider : PreviewParameterProvider<DetailsUiState> {

    /**
     * مقادیر پیش‌فرض برای پیش‌نمایش، شامل وضعیت‌های مختلف از نوع DetailsUiState.
     */
