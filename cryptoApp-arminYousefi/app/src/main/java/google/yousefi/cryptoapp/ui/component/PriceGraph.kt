...
import google.yousefi.cryptoapp.ui.theme.ZeroWhite
import java.math.BigDecimal
import kotlinx.collections.immutable.ImmutableList
import kotlinx.collections.immutable.persistentListOf

/**
 * این Composable برای نمایش نمودار قیمت استفاده می‌شود.
 *
 * @param prices لیست از قیمت‌ها به صورت ImmutableList<BigDecimal>.
 * @param priceChangePercentage درصد تغییر قیمت به صورت Percentage.
 * @param isGraphAnimated مشخص می‌کند که آیا نمودار با انیمیشن نمایش داده شود یا خیر.
